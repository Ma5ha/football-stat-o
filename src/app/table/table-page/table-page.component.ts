...
export class TablePageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.standingsService.getStandings().subscribe((result) => {
  ...
  reverseStandings(): void {
    ...
    this.standings.sort((clubA, clubB) => {
      return (
        parseInt(clubA.overall_league_position) -
        parseInt(clubB.overall_league_position)
      );
    });
    this.selected = "r";
  }
  ...
  sortByName(): void {
    ...
    this.standings.sort((clubA, clubB) => {
      if (clubA.team_name.toUpperCase() < clubB.team_name.toUpperCase())
        return -1;
      if (clubA.team_name.toUpperCase() > clubB.team_name.toUpperCase())
        return 1;
      return 0;
  ...
  sortByMostWins() {
    ...
    this.standings.sort((clubA, clubB) => {
      ...
      return (
        parseInt(clubA.overall_league_W) - parseInt(clubB.overall_league_W)
      );
    });
    this.standings.reverse();
    this.selected = "w";
  ...
  sortByMostDraws() {
    ...
    this.standings.sort((clubA, clubB) => {
      ...
      return (
        parseInt(clubA.overall_league_D) - parseInt(clubB.overall_league_D)
      );
    });
    this.standings.reverse();
    this.selected = "d";
  ...
  sortByMostLoses() {
    ...
    this.standings.sort((clubA, clubB) => {
      ...
      return (
        parseInt(clubA.overall_league_L) - parseInt(clubB.overall_league_L)
      );
    });
    this.standings.reverse();
    this.selected = "l";
  ...
  sortByGoalsFor() {
    ...
    this.standings.sort((clubA, clubB) => {
      ...
      return (
        parseInt(clubA.overall_league_GF) - parseInt(clubB.overall_league_GF)
      );
    });
    this.standings.reverse();
    this.selected = "gf";
  ...
  sortByGoalsAlowed() {
    ...
    this.standings.sort((clubA, clubB) => {
      ...
      return (
        parseInt(clubA.overall_league_GA) - parseInt(clubB.overall_league_GA)
      );
    });
    this.standings.reverse();
    this.selected = "ga";
  ...
  sortByPts() {
    ...
    this.standings.sort((clubA, clubB) => {
      ...
      return (
        parseInt(clubA.overall_league_PTS) - parseInt(clubB.overall_league_PTS)
      );
    });
    this.standings.reverse();
